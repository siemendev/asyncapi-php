...
/**
 * Abstract base class for all channel binding objects.
 *
 * Channel bindings contain protocol-specific definitions for a channel.
 */
abstract class ChannelBinding extends AsyncApiObject
{
